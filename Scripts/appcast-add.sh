...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Jamb v$VERSION</title>
      <link>https://github.com/domus-apps/jamb/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/jamb/releases/download/v$VERSION/Jamb.zip"
        $SIGNATURE_ATTRS
